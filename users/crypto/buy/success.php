    ...
    if ($status == 100) {
        ...
        if ($result->num_rows > 0) {
            ...
            if ($payment_status == "1" && $successfull_url_status == "1") {
                ...
                $result_update_transaction = mysqli_query($conn, "UPDATE $Coin_Payments_table SET payment_status='1',txn_id='$txn_id',amount='$amount', done_at='$now_utc_date_time' WHERE id='$payment_id'");
